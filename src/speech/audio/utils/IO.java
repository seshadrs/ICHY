...
/*
 * Contains methods for IO of WAV files
 * */
public final class IO {
    ...
    private static byte[] readByte(String filename) {
        ...
        try {
            ...
            // try to read from URL
                ...
                URL url = IO.class.getResource(filename);
    ...
    ***********************************************************************/
    ...
    private static double[] note(double hz, double duration, double amplitude) {
        int N = (int) (IO.SAMPLE_RATE * duration);
        double[] a = new double[N+1];
        for (int i = 0; i <= N; i++)
            a[i] = amplitude * Math.sin(2 * Math.PI * i * hz / IO.SAMPLE_RATE);
        return a;
    }
    ...
    public static void main(String[] args) {
        ...
        // 440 Hz for 1 sec
        double freq = 440.0;
        for (int i = 0; i <= IO.SAMPLE_RATE; i++) {
            IO.play(0.5 * Math.sin(2*Math.PI * freq * i / IO.SAMPLE_RATE));
        }
